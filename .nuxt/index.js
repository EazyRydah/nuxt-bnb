...
import nuxt_plugin_plugin_c04a0d08 from 'nuxt_plugin_plugin_c04a0d08' // Source: .\\components\\plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"titleTemplate":"Mastering Nuxt: %s","htmlAttrs":{"lang":"en"},"bodyAttrs":{"class":["my-style"]},"meta":[{"chartset":"utf-8"}],"link":[],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_c04a0d08 === 'function') {
    await nuxt_plugin_plugin_c04a0d08(app.context, inject)
  }
