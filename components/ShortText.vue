...
export default {
    ...
    // created runs on server AND client - so initial loaded content is correctly formatted
    // mounted only on clientside - so initial text would be long and then strangeley shortened
    created() {
