    ...
    <div>
        ...
        <div v-if="homes.length > 0">
            <nuxt-link v-for="home in homes" :key="home.objectID" :to="`/home/${home.objectID}`">
                <HomeRow :home="home" @mouseover.native="hightlightMarker(home.objectID, true)" @mouseout.native="hightlightMarker(home.objectID, false)"/>
            </nuxt-link>
        </div>
...
export default {
    ...
    methods: {
        hightlightMarker(homeId, isHighlighted){
            // ? nullable is es6 stuff, will be compiled in simple if-statements by nuxt automagically
